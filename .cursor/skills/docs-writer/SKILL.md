...
```tsx
// Always subpath imports for @keystoneui/react
...
- [ ] Imports use subpath pattern: `@keystoneui/react/[component]`
...
2. **Wrong import paths** — must be `@keystoneui/react/[component]`, not `@keystoneui/react` barrel import.
