...
- **MCP Server** (`@keystoneui/mcp`) — 8 tools for project context, component discovery, source inspection, demo fetching, install commands, theme info, and post-install audit. Works with Claude Code, Cursor, VS Code Copilot, OpenCode, Codex.
