    ...
    variants: {
      orientation: {
        horizontal: [
          ...
          "[&>[data-slot]~[data-slot]:not([data-input])]:border-l-0",
          ...
          "[&>[data-slot]:not([data-slot=button])~[data-input]]:-ml-px",
          "[&>[data-slot]:not([data-slot=button])~[data-input]]:border-l",
          "[&>[data-slot]:not([data-slot=button])~[data-input]:not(:focus-within)]:border-l-transparent",
          ...
          "[&>[data-slot=button]+[data-input]]:-ml-px",
          "[&>[data-slot=button]+[data-input]]:border-l",
          "[&>[data-slot=button]+[data-input]:not(:focus-within)]:border-l-transparent",
          // Input before button: keep right border but transparent when unfocused,
          // negative margin to overlap — so both ring layers render on focus
          "[&>[data-input]:has(+[data-slot=button])]:-mr-px",
          "[&>[data-input]:has(+[data-slot=button])]:border-r",
          "[&>[data-input]:has(+[data-slot=button]):not(:focus-within)]:border-r-transparent",
          // Subtle separator between adjacent buttons and between buttons and inputs
          "[&>[data-slot=button]:has(+:is([data-slot=button],[data-input]))]:border-r-0!",
          ...
          "[&>[data-slot=button]:has(+[data-input])]:after:content-['']",
          "[&>[data-slot=button]:has(+[data-input])]:after:absolute",
          "[&>[data-slot=button]:has(+[data-input])]:after:right-0",
          "[&>[data-slot=button]:has(+[data-input])]:after:top-[25%]",
          "[&>[data-slot=button]:has(+[data-input])]:after:w-px",
          "[&>[data-slot=button]:has(+[data-input])]:after:h-[50%]",
          "[&>[data-slot=button]:has(+[data-input])]:after:bg-current",
          "[&>[data-slot=button]:has(+[data-input])]:after:opacity-15",
          "[&>[data-slot=button]:has(+[data-input])]:after:rounded-sm",
          // Subtle separator: input → button (via before: on the button)
          "[&>[data-input]+[data-slot=button]]:before:content-['']",
          "[&>[data-input]+[data-slot=button]]:before:absolute",
          "[&>[data-input]+[data-slot=button]]:before:left-0",
          "[&>[data-input]+[data-slot=button]]:before:top-[25%]",
          "[&>[data-input]+[data-slot=button]]:before:w-px",
          "[&>[data-input]+[data-slot=button]]:before:h-[50%]",
          "[&>[data-input]+[data-slot=button]]:before:bg-current",
          "[&>[data-input]+[data-slot=button]]:before:opacity-15",
          "[&>[data-input]+[data-slot=button]]:before:rounded-sm",
        ].join(" "),
        vertical: [
          "flex-col",
          "[&>[data-slot]:not(:has(~[data-slot]))]:rounded-b-lg!",
          "[&>[data-slot]~[data-slot]]:rounded-t-none",
          "[&>[data-slot]~[data-slot]:not([data-input])]:border-t-0",
          "*:data-[slot]:rounded-b-none",
          // Input focus fix (non-button predecessors only): keep 1px border,
          // transparent when unfocused, negative margin to overlap preceding border.
          // Uses ~ (general sibling) instead of + because Base UI Select renders a
          // hidden <select> between the trigger and the input, breaking adjacency.
          "[&>[data-slot]:not([data-slot=button])~[data-input]]:-mt-px",
          "[&>[data-slot]:not([data-slot=button])~[data-input]]:border-t",
          "[&>[data-slot]:not([data-slot=button])~[data-input]:not(:focus-within)]:border-t-transparent",
          // Input after button: keep top border but transparent when unfocused,
          // negative margin to overlap — so both ring layers render on focus
          "[&>[data-slot=button]+[data-input]]:-mt-px",
          "[&>[data-slot=button]+[data-input]]:border-t",
          "[&>[data-slot=button]+[data-input]:not(:focus-within)]:border-t-transparent",
          // Input before button: keep bottom border but transparent when unfocused,
          // negative margin to overlap — so both ring layers render on focus
          "[&>[data-input]:has(+[data-slot=button])]:-mb-px",
          "[&>[data-input]:has(+[data-slot=button])]:border-b",
          "[&>[data-input]:has(+[data-slot=button]):not(:focus-within)]:border-b-transparent",
          // Subtle separator between adjacent buttons and between buttons and inputs
          "[&>[data-slot=button]:has(+:is([data-slot=button],[data-input]))]:border-b-0!",
          "[&>[data-slot=button]~[data-slot=button]]:before:content-['']",
          "[&>[data-slot=button]~[data-slot=button]]:before:absolute",
          ...
          "[&>[data-slot=button]:has(+[data-input])]:after:content-['']",
          "[&>[data-slot=button]:has(+[data-input])]:after:absolute",
          "[&>[data-slot=button]:has(+[data-input])]:after:bottom-0",
          "[&>[data-slot=button]:has(+[data-input])]:after:left-[25%]",
          "[&>[data-slot=button]:has(+[data-input])]:after:h-px",
          "[&>[data-slot=button]:has(+[data-input])]:after:w-[50%]",
          "[&>[data-slot=button]:has(+[data-input])]:after:bg-current",
          "[&>[data-slot=button]:has(+[data-input])]:after:opacity-15",
          "[&>[data-slot=button]:has(+[data-input])]:after:rounded-sm",
          // Subtle separator: input → button (via before: on the button)
          "[&>[data-input]+[data-slot=button]]:before:content-['']",
          "[&>[data-input]+[data-slot=button]]:before:absolute",
          "[&>[data-input]+[data-slot=button]]:before:top-0",
          "[&>[data-input]+[data-slot=button]]:before:left-[25%]",
          "[&>[data-input]+[data-slot=button]]:before:h-px",
          "[&>[data-input]+[data-slot=button]]:before:w-[50%]",
          "[&>[data-input]+[data-slot=button]]:before:bg-current",
          "[&>[data-input]+[data-slot=button]]:before:opacity-15",
          "[&>[data-input]+[data-slot=button]]:before:rounded-sm",
        ].join(" "),
