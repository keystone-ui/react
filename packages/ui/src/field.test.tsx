...
describe("FieldSet", () => {
  ...
  test("applies custom className", () => {
    render(
      <FieldSet className="custom-class" data-testid="fieldset">
        Content
      </FieldSet>
    );
    const fieldset = screen.getByTestId("fieldset");
...
describe("FieldGroup", () => {
  ...
  test("applies custom className", () => {
    render(
      <FieldGroup className="grid grid-cols-2" data-testid="group">
        Content
      </FieldGroup>
    );
    const group = screen.getByTestId("group");
...
describe("FieldLabel", () => {
  ...
  test("applies custom className", () => {
    render(
      <FieldLabel className="font-normal" data-testid="label">
        Label Text
      </FieldLabel>
    );
    const label = screen.getByTestId("label");
...
describe("FieldDescription", () => {
  ...
  test("applies custom className", () => {
    render(
      <FieldDescription className="custom-class" data-testid="description">
        Description text
      </FieldDescription>
    );
    const description = screen.getByTestId("description");
...
describe("FieldError", () => {
  ...
  test("renders multiple errors as list", () => {
    render(
      <FieldError errors={[{ message: "Error 1" }, { message: "Error 2" }]} />
    );
  ...
  test("deduplicates errors with same message", () => {
    render(
      <FieldError
        errors={[{ message: "Duplicate" }, { message: "Duplicate" }]}
      />
    );
  ...
  test("applies custom className", () => {
    render(
      <FieldError className="custom-class" data-testid="error">
        Error
      </FieldError>
    );
    const error = screen.getByTestId("error");
...
describe("FieldContent", () => {
  ...
  test("applies custom className", () => {
    render(
      <FieldContent className="custom-class" data-testid="content">
        Content
      </FieldContent>
    );
    const content = screen.getByTestId("content");
...
describe("Field Integration", () => {
      ...
      <FieldSet data-testid="fieldset">
        ...
        <FieldGroup data-testid="group">
          <Field data-testid="field">
            <FieldLabel data-testid="label" htmlFor="name">
              Name
            </FieldLabel>
            <input data-testid="input" id="name" />
            <FieldDescription data-testid="description">
              Enter your name
            </FieldDescription>
          </Field>
  ...
  test("renders field with error state", () => {
    render(
      <Field data-invalid data-testid="field">
        ...
        <input aria-invalid data-testid="input" id="email" />
  ...
  test("renders horizontal field with checkbox/switch pattern", () => {
    render(
      <Field data-testid="field" orientation="horizontal">
        <input data-testid="checkbox" id="terms" type="checkbox" />
        <FieldLabel data-testid="label" htmlFor="terms">
          Accept terms
        </FieldLabel>
      </Field>
    );
